...
<?php do_action( 'before' ); ?>
	...
	<div role="navigation" class="site-navigation secondary-navigation" id="secondary-menu">
		<h1 class="assistive-text"><?php _e( 'Menu', 'p2' ); ?></h1>
		<div class="assistive-text skip-link"><a href="#secondary" title="<?php esc_attr_e( 'Skip to content', 'p2' ); ?>"><?php _e( 'Skip to content', 'p2' ); ?></a></div>
